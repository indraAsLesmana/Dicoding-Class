...
class MainMenuTest{
    ...
    private val layoutId = arrayOf(eventLastFragment, eventNextFragment, favoriteFragment)
    private val rvId = arrayOf(rvLastEvent, rvNextEvent, rvFavorite)
    ...
    fun testFavoriteUnfavorite() {
        val lastMatchMenu = menuId[0]
        val recyclerViewLastMatch = rvId[0]
        val repeatTime = 4  //repeat as you like
        ...
        repeat(repeatTime){
            ...
            onView(withId(layDetailLastEvent))
                .check(matches(isDisplayed()))
